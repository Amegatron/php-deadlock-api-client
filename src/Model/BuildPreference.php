...
/**
 * BuildPreference Class Doc Comment
 *
 * @category Class
 * @package  DeadlockApi
 * @author   OpenAPI Generator team
 ...
 */
class BuildPreference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BuildPreference';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reported'] === null) {
            $invalidProperties[] = "'reported' can't be null";
        }
    ...
    {
        if (is_null($reported)) {
            throw new \InvalidArgumentException('non-nullable reported cannot be null');
        }
